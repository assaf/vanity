...
*Step 1:* Set up Vanity for your Rails application:

<em>Rails 3.x or 4.x:</em>
...
Then activate vanity in your ApplicationController:
...
*Step 2:* Define your first metric. This goes in the file <code>experiments/metrics/signup.rb</code>:
...
*Step 3:* Define your first A/B test.  This experiment goes in the file <code>experiments/price_options.rb</code>:
...
*Step 4:* Present the different options to your users:
