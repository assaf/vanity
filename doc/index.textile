...
* "Experiment Driven Development":http://blog.labnotes.org/2009/11/19/vanity-experiment-driven-development-for-rails/
* "Get the code":http://github.com/assaf/vanity
* "API reference":api/index.html
* "Join the group group":http://groups.google.com/group/vanity-talk
