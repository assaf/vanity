...
If you have RVM installed, @rake test:rubies@ will install all the supported Ruby implementations and populate the @vanity@ gemset for you. To test all supported adapters, you will also need to install Redis and MongoDB. If working on the Mac, you can easily install them all using "Homebrew":http://github.com/mxcl/homebrew.
