...
== Testing emails in rails 3

Sometimes you may be delivering emails to users in the background or without the context of the request. ActionMailler inherits from AbstractController (just like ActionController does). This let's you include the modules that same way in your mailer.  Example:
  ...
  class Notifications < ActionMailer::Base
    ...
    def simple_ab_test(options = {})
      ...
      if Rails.env == "test"
        ...
        Vanity.playground.experiment(:my_example_experiment).chooses(options[:alternative])
      end
      
      body_text =  ab_test(:my_example_experiment)
      
      mail(:to => "test@example.com",:from => "support@example.com",:subject => "A/B Subject" ) do |fmt|
        fmt.text { render :text => body_text}
      end
    ensure
