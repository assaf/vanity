...
* Documentation: http://assaf.github.com/vanity
...
<b>Step 4:</b> Measure conversion:
  ...
  class SignupController < ApplicationController
    def signup
      ...
      if @account.save
        ab_goal! :pricing_options # <- here be conversion!
...
jQuery, Copyright (c) 2009 John Resig, released under the MIT license:
http://dev.jquery.com

Flot, Copyright (c) 2007-2009 IOLA and Ole Laursen, released under teh MIT
license: http://code.google.com/p/flot
